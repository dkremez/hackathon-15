    ...
    return (
      <form className="input-group col-md-12">
        <div className="input-group-btn">
          <select className="form-group btn selected-category" ref="category" onChange={this.searchCategoryChanged}>
        ...
        <input onChange={this.searchTextChanged} ref="search" type="text" className="form-control col-md-6"
            ...
            <span className="input-group-btn">
                <button className="btn btn-primary show-all" type="button" onClick={DiscountActions.getDiscounts}>Все
                </button>
            </span>
      </form>
    );
